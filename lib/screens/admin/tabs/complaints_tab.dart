  ...
  Future<void> _saveStatus(int complaintId, String newStatus) async {
    try {
      ...
      setState(() {
        ...
        _editingStatuses.remove(complaintId);
      });
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              'Статус обновлён: ${_formatComplaintStatus(newStatus)}',
            ),
        ...
        child: _isLoading
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final complainant =
                      complaint['complainant'] as Map<String, dynamic>?;
                  final complainantName =
                      complainant?['display_name'] as String? ??
                  ...
                  final currentEditingStatus =
                      _editingStatuses[complaintId] ?? status;
